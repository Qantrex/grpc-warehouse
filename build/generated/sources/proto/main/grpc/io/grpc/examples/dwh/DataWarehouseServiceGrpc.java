...
public final class DataWarehouseServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "dwh.DataWarehouseService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<io.grpc.examples.dwh.WarehouseRecord,
      io.grpc.examples.dwh.TransferReply> getTransferWarehouseRecordMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "TransferWarehouseRecord",
      requestType = io.grpc.examples.dwh.WarehouseRecord.class,
      responseType = io.grpc.examples.dwh.TransferReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.grpc.examples.dwh.WarehouseRecord,
      io.grpc.examples.dwh.TransferReply> getTransferWarehouseRecordMethod() {
    io.grpc.MethodDescriptor<io.grpc.examples.dwh.WarehouseRecord, io.grpc.examples.dwh.TransferReply> getTransferWarehouseRecordMethod;
    if ((getTransferWarehouseRecordMethod = DataWarehouseServiceGrpc.getTransferWarehouseRecordMethod) == null) {
      synchronized (DataWarehouseServiceGrpc.class) {
        if ((getTransferWarehouseRecordMethod = DataWarehouseServiceGrpc.getTransferWarehouseRecordMethod) == null) {
          DataWarehouseServiceGrpc.getTransferWarehouseRecordMethod = getTransferWarehouseRecordMethod =
              io.grpc.MethodDescriptor.<io.grpc.examples.dwh.WarehouseRecord, io.grpc.examples.dwh.TransferReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "TransferWarehouseRecord"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.grpc.examples.dwh.WarehouseRecord.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.grpc.examples.dwh.TransferReply.getDefaultInstance()))
              .setSchemaDescriptor(new DataWarehouseServiceMethodDescriptorSupplier("TransferWarehouseRecord"))
              .build();
        }
      }
    }
    return getTransferWarehouseRecordMethod;
  }
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void transferWarehouseRecord(io.grpc.examples.dwh.WarehouseRecord request,
        io.grpc.stub.StreamObserver<io.grpc.examples.dwh.TransferReply> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getTransferWarehouseRecordMethod(), responseObserver);
    }
  }
  ...
  public static final class DataWarehouseServiceStub
     ...
     * </pre>
     */
    public void transferWarehouseRecord(io.grpc.examples.dwh.WarehouseRecord request,
        io.grpc.stub.StreamObserver<io.grpc.examples.dwh.TransferReply> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getTransferWarehouseRecordMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class DataWarehouseServiceBlockingV2Stub
     ...
     * </pre>
     */
    public io.grpc.examples.dwh.TransferReply transferWarehouseRecord(io.grpc.examples.dwh.WarehouseRecord request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getTransferWarehouseRecordMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class DataWarehouseServiceFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<io.grpc.examples.dwh.TransferReply> transferWarehouseRecord(
        io.grpc.examples.dwh.WarehouseRecord request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
          getChannel().newCall(getTransferWarehouseRecordMethod(), getCallOptions()), request);
    }
  }

  private static final int METHODID_TRANSFER_WAREHOUSE_RECORD = 0;
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_TRANSFER_WAREHOUSE_RECORD:
          serviceImpl.transferWarehouseRecord((io.grpc.examples.dwh.WarehouseRecord) request,
              (io.grpc.stub.StreamObserver<io.grpc.examples.dwh.TransferReply>) responseObserver);
          break;
        default:
  ...
  public static final io.grpc.ServerServiceDefinition bindService(AsyncService service) {
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          getTransferWarehouseRecordMethod(),
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              io.grpc.examples.dwh.WarehouseRecord,
              io.grpc.examples.dwh.TransferReply>(
                service, METHODID_TRANSFER_WAREHOUSE_RECORD)))
        .build();
  }
  ...
  private static abstract class DataWarehouseServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return io.grpc.examples.dwh.DwhProto.getDescriptor();
    }
      ...
      synchronized (DataWarehouseServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getTransferWarehouseRecordMethod())
              .build();
        }
      }
    }
